...
parser.add_argument('--image_size', dest='image_size', type=int, default=CANVAS_SIZE,
...
parser.add_argument('--embedding_num', dest='embedding_num', type=int, default=80,
...
parser.add_argument('--checkpoint_steps', dest='checkpoint_steps', type=int, default=50,
